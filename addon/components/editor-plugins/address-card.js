...
import layout from '../../templates/components/editor-plugins/address-card';
...
export default Component.extend({
  ...
  */
  ...
  actions: {
    insert(){
      this.get('hintsRegistry').removeHintsAtLocation(this.get('location'), this.get('hrId'), 'editor-plugins/address-card');
